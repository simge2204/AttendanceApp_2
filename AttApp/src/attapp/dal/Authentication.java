...
return stud;
    ...
    public static Teacher validateTeacherLogin(String username, String password) throws SQLException, IOException {
        ...
        while (rs.next())
        {
            ...
            if (teach != null) {
                ...
                while (rsClasses.next()) {
                    ...
                    int id = rsClasses.getInt("classID");
                    SchoolClass sClass = new SchoolClass(className,id);
